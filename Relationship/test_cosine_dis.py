...
MODEL_CONFIGS: Dict[str, List[ModelConfig]] = {
    ...
    #     ModelConfig(
    #         name='Llama-2-7b-hf',
    #         activation_path_template='activation_datasets/meta-llama-Llama-2-7b-hf/atomic mass/atomic mass.last.11_templates.{layer}.pt',
    #         num_layers=32
    #     ),
    #     # Add more models if needed
    # ],
    ...
    #     ModelConfig(
    #         name='Llama-2-7b-hf',
    #         activation_path_template='activation_datasets/meta-llama-Llama-2-7b-hf/period/period.last.11_templates.{layer}.pt',
    #         num_layers=32
    #     ),
    #     # Add more models if needed
    # ],
    ...
    #     ModelConfig(
    #         name='Llama-2-7b-hf',
    #         activation_path_template='activation_datasets/meta-llama-Llama-2-7b-hf/electronegativity/electronegativity.last.11_templates_quesiontions.{layer}.pt',
    #         num_layers=32
    #     ),
...
OUTPUT_DIR = 'results_cosine_distance'  # Updated output directory name
